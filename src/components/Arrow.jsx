export default function Arrow(props) {
    ...
    return (
        <div className="arrow-wrapper">
            <svg id={props.id} className={`arrow ${(!props.showArrow) ? "hide": ""}`} width="100%" height="100%" viewBox="0 0 36 64" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" xmlnsserif="http://www.serif.com/" style={{ fillRule: 'evenodd', clipRule: 'evenodd', strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 1.5 }} onClick={() => handleClick()}>
